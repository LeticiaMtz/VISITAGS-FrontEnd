...
export class ReasonsCRDEComponent implements OnInit {
  ...
  constructor(private reasonsService: ReasonsCrdeService, private route: Router, private _PdfService: PdfServiceService, private _excelService: ExportDataService) { }
  ...
  exportAsXLSX() {
    if (this.reasons.length !== 0) {
      ...
      for (let i = 0; i < count; i++) {
        ...
        delete jsonobject2[i].aJsnCategoria;
